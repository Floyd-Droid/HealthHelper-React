...
export default function NavbarWrapper(props)  {
	const { user, isUserLoading, setIsBodyLoading } = useContext(UserContext);
	const location = window.location;

	const updateIsBodyLoading = () => {
				...
				<Container fluid className='d-flex justify-content-between align-items-center p-0'>
					<Container fluid className='d-flex align-items-center'>
						<Nav activeKey={location.pathname}>
							...
							<Nav.Link href="/log" className='d-flex justify-content-center align-items-center' onClick={updateIsBodyLoading}>
							...
							<Nav.Link href="/log/create" className='d-flex justify-content-center align-items-center' onClick={updateIsBodyLoading}>
							...
							<Nav.Link href="/index" className='d-flex justify-content-center align-items-center' onClick={updateIsBodyLoading}>
								<svg height="20" viewBox="0 0 64 64" width="20" xmlns="http://www.w3.org/2000/svg">
									<g fill="none" fillRule="evenodd">
							...
							{!isUserLoading &&
								<Container fluid className='d-flex justify-content-end align-items-center'>
									...
									<NavDropdown className='me-3' title={user ? user.displayName : 'User'} id="basic-nav-dropdown" menuVariant='dark'>
										<NavDropdown.Item href="/settings" onClick={updateIsBodyLoading}>Settings</NavDropdown.Item>
										<NavDropdown.Item href="/login" onClick={navLogout}>Log out</NavDropdown.Item>
									</NavDropdown>
								</Container>
							}
						</Nav>
