	...
	return (
		<Navbar className='h-100' bg='dark' variant='dark' expand="sm" >
			<Navbar.Brand href="" className='brand-container'>
				...
				<span className='mx-1'>HealthHelper</span>
			</Navbar.Brand>
			<Navbar.Toggle aria-controls="basic-navbar-nav" />
			<Navbar.Collapse id="basic-navbar-nav">
				<Nav className="me-auto" activeKey={location.pathname}>
					<Nav.Link href="/log" className='d-flex justify-content-center align-middle'>
					...
					<Nav.Link href="/index" className='d-flex justify-content-center align-middle'>
					...
					<NavDropdown className='mr-auto' title={user ? user.displayName : 'User'} id="basic-nav-dropdown">
