...
export default function Settings() {
	...
	const handleLinkAuthAccount = async (type) => {
		setIsRedirecting(true);
		setIsBodyLoading(true);
		const res = await authProviderLink(type);
		updateMessages(res);
			...
			<div className='container d-flex justify-content-center text-white my-3'>
				<div className='settings-container form-container rounded'>
					...
					<div className='settings-section p-3 mt-5'>
						...
						<div className='mt-4'>
							<div className='my-3'>
								<button type='button' className='btn form-btn' onClick={() => handleLinkAuthAccount('google')}>
							...
							<div className='my-3'>
								<button type='button' className='btn form-btn' onClick={() => handleLinkAuthAccount('github')}>
									<svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 48 48" width="28px" height="28px">
										...
										<stop offset="1" stopColor="#343434"/></linearGradient>
									...
									<span className='ms-2'>Link with Github</span>
								</button>
							</div>
