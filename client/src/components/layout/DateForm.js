  ...
  const incrementDate = (num) => {
	...
	return (
		<div className='d-flex justify-content-center align-items-center'>
			<Button variant='outline-light' className='border-0 px-2 py-0 me-2' onClick={() => incrementDate(-1)}>
			...
			<Button variant='outline-light' className='border-0 px-2 py-0 ms-2' onClick={() => incrementDate(1)}>
